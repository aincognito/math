...
A 10-foot ladder is sliding down a wall at a rate of 1 foot per second.  How fast is the base of the 
...
Here is a video solution of  problem 8c:
\begin{foldable}
\youtube{shxLV1-Xpeo}
\end{foldable}

\begin{example}[example 9]
A streetlight is mounted at the top of a 15 ft tall pole.  
...
A streetlight is mounted at the top of a 20 ft tall pole.  
...
Here is a video solution of  problem 11:
\begin{foldable}
\youtube{GeBBHzQhlts}
\end{foldable}
