...
\begin{tikzpicture}[background rectangle/.style=
    {double,ultra thick,draw=blue,rounded corners},
...
Here is a vidoe solution of problem 1c:\\
\begin{foldable}
\youtube{Qt-Aoldk41I}
\end{foldable}
...
Here is a video solution of one part of problem 3, part ii:\\
\begin{foldable}
\youtube{2y0fdV8ihG0}
\end{foldable}
...
Here is a video solution of one part of problem 4, part iii:\\
\begin{foldable}
\youtube{X2glIMUFc6E}
\end{foldable}
