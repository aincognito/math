...
The next problem gives the slope of the tangent line to the exponential function at $x=0$.



\begin{problem}(problem 2c)
Fill in the missing values to 3 decimal places and then use the table below to guess the limits.
...
$\displaystyle \lim_{x \to 0^+} \frac{e^x - 1}{x} = \answer{1}$	\\
$\displaystyle \lim_{x \to 0^-} \frac{e^x - 1}{x} = \answer{1}$\\
Based on the one-sided limits, determine the two-sided limit: $\displaystyle \lim_{x \to 0} \frac{e^x - 1}{x} = \answer{1}$

It should be noted that plugging $x=0$ into the 
function $\displaystyle{\frac{e^x -1}{x}}$ yields the indeterminate form $\displaystyle\frac{0}{0}$, which is not a final answer
\end{problem}

The next problem gives the slope of the tangent line to the function $\sin x$ at $x=0$.

\begin{problem}(problem 2d)
Fill in the missing values to 4 decimal places and then use the table below to guess the limits (make sure your calculator is in radian mode).
\[
\begin{array}{|c | c|}
	\hline
  x & \frac{\sin x}{x} \\ 
...
Now use the numerical information to guess the one-sided limits:\\
$\displaystyle \lim_{x \to 0^+} \frac{\sin x}{x} = \answer{1}$	\\
$\displaystyle \lim_{x \to 0^-} \frac{\sin x}{x} = \answer{1}$\\
...
The next problem gives the slope of the tangent line to the natural logarithm function at $x=1$.

\begin{problem}(problem 2e)
Fill in the missing values to 3 decimal places and then use the tables below to determine the limits.
\[
\begin{array}{| c | c|}
  x & \frac{\ln(1+x)}{x}\\ 
  \hline
...
Now use the numerical information to guess the one-sided limits:\\
$\displaystyle \lim_{x \to 0^+} \frac{\ln(1+x)}{x} = \answer{1}$	\\
$\displaystyle \lim_{x \to 0^-} \frac{\ln(1+x)}{x} = \answer{1}$\\
