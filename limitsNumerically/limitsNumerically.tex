...
%In the following problem, the variable $x$ is approaching the 
%value $3$ from the left-hand side. Meanwhile, 
%the behavior of the quantity $x^2 + 2$ is of interest.  
...
\begin{array}{ c | c | c  }
  x  & -0.001 & -0.0001 \\ 
	\hline 
	 \frac{e^x - 1}{x}  & \answer{0.9995} & \answer{0.99995}
\end{array}
\]
\end{center}
Now determine the limit:
...
\begin{array}{ c | c | c  }
  x  & 0.001 & 0.0001 \\ 
	\hline 
	 \frac{e^{2x} - 1}{x}  & \answer{2.002} & \answer{2.0002}
\end{array}
\]
\end{center}
Now determine the limit:
...
\begin{array}{ c | c | c }
  x & -0.1 & -0.01   \\ 
	\hline 
	 \frac{\sin(x)}{x} & \answer{0.9983} & \answer{0.99998} 
\end{array}
\]
\[
\begin{array}{ c | c | c  }
  x  & -0.001 & -0.0001 \\ 
	\hline 
	 \frac{\sin(x)}{x}  & \answer{0.999998} & \answer{0.9999998}
\end{array}
\]
\end{center}
Now determine the limit:
...
\begin{array}{ c | c | c }
  x & 0.1 & 0.01   \\ 
	\hline 
	 \frac{\sin(3x)}{x} & \answer{2.9552} & \answer{2.99955} 
\end{array}
\]
\[
\begin{array}{ c | c | c  }
