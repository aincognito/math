...
Fill in the missing values and then use the table below to guess the limits.
...
Fill in the missing values to 4 decimal placesand then use the table below to guess the limits (make sure your calculator is in radian mode).
\[
\begin{array}{|c | c|}
	\hline
  x & \frac{\sin x}{x} \\ 
