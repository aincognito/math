...
\[
l = \left(\begin{array}{c} 1 \\ 2 \\ 3 \end{array}\right)
\qquad
...
function $\displaystyle{\frac{e^x -1}{x}}$ yields the indeterminate form $\frac{0}{0}$, which is not
...
function $\displaystyle{\frac{\sin x}{x}}$ yields the indeterminate form $\frac{0}{0}$.
