...
First, if we plug $x = 1$ into the function, we get the fraction  $0/0$, which is called an \textbf{indeterminate form}. 
...
To determine the limit numerically,  we will plug these five values of $x$ into the function $f(x) =\frac{x^3 - 1}{x^2-1}$ and  
look for a pattern in the outputs.
...
If $x = 1.00001$ then $f(x) = 1.5000075$.\\
...
\[\lim_{x \to 1^+} f(x) \lim_{x \to 1^+} \frac{x^3 - 1}{x^2-1} = 1.5.\] 
...
Fill in the table below with 5 decimal places of accuracy and use it to find the limit: $\displaystyle \lim_{x \to 2^+} f(x) = \lim_{x \to 2^+} \frac{x^3 - 8}{x^2 - 4}$\\
...
Compute the following limit: $\displaystyle \lim_{x \to 0^{+}} \frac{e^x-1}{x}$\\
In this example, $x$ is near $0$ and $x>0$.  The values of $x$ we will use to 
generate a table are: $0.1, 0.01, 0.001$ and $0.0001.$
...
Based on the numerical information provided in the table above, we conclude that $\displaystyle \lim_{x \to 0^+} \frac{e^x - 1}{x} = 1$	\\
...
Fill in the table below with 5 decimal places of accuracy and use it to find the limit: $\displaystyle \lim_{x \to 0^-} \frac{e^x - 1}{x}$\\
...
\begin{array}{ c | c }
 ...
 -0.01 & \answer{0.99502} \\
  \hline
 -0.001 & \answer{0.99950} \\
  \hline
 -0.0001 & \answer{0.99995}
\end{array}
\]

Now determine the limit: $\displaystyle \lim_{x \to 0^-} \frac{e^x - 1}{x} = \answer{1}$\\


Based on the example above and the result of this problem, determine the two-sided limit: $\displaystyle \lim_{x \to 0} \frac{e^x - 1}{x}= \answer{1}$
...
Use the tables below to determine the limits:
\[
\begin{array}{ c | c c c|c}
  x & \frac{\ln(1+x)}{x}& &x & \frac{\ln(1+x)}{x}\\ \hline
  0.1 & 0.953 & &-0.1 & 1.054 \\ \hline
   % \cline{1-2} \cline{4-5}
	  0.01 & 0.995 & &-0.01 & 1.005 \\ \hline
	 %\cline{1-2} \cline{4-5}
	  0.001 & 0.9995 & &-0.001 & 1.0005 \\ \hline
	% \cline{1-2} \cline{4-5}
...
\begin{tabular}{ c | c c c|c}
  $x$ & $\frac{\ln(1+x)}{x}$& &$x$ & $\frac{\ln(1+x)}{x}$\\ 
  \cline{1-2} \cline{4-5}
  0.1 & 0.953 & &-0.1 & 1.054 \\
   \cline{1-2} \cline{4-5}
	  0.01 & 0.995 & &-0.01 & 1.005 \\ 
	 \cline{1-2} \cline{4-5}
	  0.001 & 0.9995 & &-0.001 & 1.0005 \\ 
	 \cline{1-2} \cline{4-5}
	  0.0001 & 0.99995 & &-0.0001 & 1.00005\\
\end{tabular}
...
\[
\lim_{x \to 0^-} \frac{\ln(1 + x)}{x} = \answer{1}
\]
\[
\lim_{x \to 0^+} \frac{\ln(1 + x)}{x} = \answer{1}
\]
...
Compute the following limit: $\displaystyle \lim_{x \to 0^{+}} \frac{\sin x}{x}$\\
...
\begin{array}{ c | c }
  x & \frac{\sin x}{x}\\
  \hline
  -0.1 & \answer{0.998334166} \\ 
	\hline 
	  -0.01 & \answer{0.999983333}\\
	  \hline
	  -0.001 & \answer{0.999999833}\\
	  \hline
	  -0.0001 & \answer{0.999999998}
\end{array}
\]

Now determine the limit: $\displaystyle \lim_{x \to 0^-} \frac{\sin x}{x} = \answer{1}	$\\
...
asymptote (on the right end)for the graph of the function $f(x) = \frac{3x -2}{x +3}.$
\end{example}
...
asymptote for the graph of the function $f(x) = \frac{3x-2}{5x+6}$.	
\end{problem}
