...
\begin{center}
\begin{tikzpicture}
\node at (2.5, 3.3) {Area = length $\times$ width};
\draw (0,0) --(5, 0) -- (5, 3) -- (0, 3) -- (0, 0);
\draw[<->] (5.3, 0) --(5.3,3) node[right, midway]{y};
\draw (3, 0) -- (3, 3);
...
\begin{image}
\begin{tikzpicture}
\begin{axis}[axis lines = center,  axis y line=center, ticks=none, xmin=-0.5, xmax = 4.5, xlabel=$x$, ylabel=$A$, ymin = -0.5, ymax = 4.5, 
