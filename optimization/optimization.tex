...
To verify that this is $x$-value gives the minimum time, we can use the closed interval method from section 3.2 (Extreme Value Theorem).
We compare the values of $T$ at the critical number and the endpoints of the interval:
\[
T(0) = \frac02 +  \sqrt{50^2 + 100^2} = \sqrt{12500} \approx 111.80,
\]
\[
...
\]
The minimum time to reach the prey is  $T \approx 93.3$ seconds and this is achieved by walking $100 -x \approx 71.13$ meters, and
then swimming directly towards the prey.
\end{example}
