...
The {\bf real part} of $\,a+bi\,$ is `$a$' and the {\bf imaginary part} of $\,a+bi\,$ is $\lq b \rq$.
\end{definition}
...
(iv) \quad $0$  \wordChoice{\choice{real}\choice{imaginary}
...
\choice[correct]{$\cos(\pi/6) + i\sin(\pi/6)$ \quad and \quad $\frac{\sqrt 3}{2} + \frac12 i$}
