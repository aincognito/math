...
\[
\lim_{x \to 0} \frac{\sin(3x)}{6x} \,\overset{\text{L'H}}{\scalebox{1.5}[1]{=}}\, \lim_{x \to 0} \frac{3\cos(3x)}{6} = \frac12
\]
\end{example}
...
We have 
\[
\lim_{x \to 0} \frac{e^{4x} - 1}{12x} \,\overset{\text{L'H}}{=}\, \lim_{x \to 0} \frac{4e^{4x}}{12} = \frac13
\]
\end{example}
...
\[\lim_{x \to 2} \frac{x^3 - 8}{x^5 - 32} \,\overset{\text{L'H}}{=}\, \lim_{x \to 2} \frac{3x^2}{5x^4} = \frac{12}{80} = \frac{3}{20}.\]
\end{example}
...
the indeterminate form $\frac00$, so L'Hopital's rule applies.
We have 
\[\lim_{x \to 0} \frac{e^x - x - 1}{x^2} \,\overset{\text{L'H}}{=}\, \lim_{x \to 0} \frac{e^x -1}{2x} = \frac{0}{0}.\]
Applying L'Hopital's Rule again gives
\[\lim_{x \to 0} \frac{e^x -1}{2x} \,\overset{\text{L'H}}{=}\, \frac{e^x}{2} = \frac{1}{2}.\]
...
the indeterminate form $\frac00$, so L'Hopital's rule applies.
We have 
\[\lim_{x \to 0} \frac{\tan(x)-x}{x^3} \,\overset{\text{L'H}}{=}\, \lim_{x \to 0} \frac{\sec^2(x)-1}{3x^2} = \frac{0}{0}.\]
Applying L'Hopital's Rule again gives
\[\lim_{x \to 0} \frac{\sec^2(x)-1}{3x^2} \,\overset{\text{L'H}}{=}\, \lim_{x \to 0} \frac{2\sec^2(x)\tan(x)}{6x} = \frac{0}{0}.\]	
...
\lim_{x \to 0} \sec^2(x) \cdot \lim_{x \to 0} \frac{2\tan(x)}{6x}\,\overset{\text{L'H}}{=}\,\]
...
We have 
\[\lim_{x\to \infty} \frac{x^2}{e^x} \,\overset{\text{L'H}}{=}\, \lim_{x \to \infty} \frac{2x}{e^x} = \frac{\infty}{\infty}.\]
Applying L'Hopital again, we get
\[\lim_{x \to \infty} \frac{2x}{e^x} \,\overset{\text{L'H}}{=}\, \lim_{\infty} \frac{2}{e^x} = 0.\]
...
We have:
\[\lim_{x \to \infty} \frac{\sqrt x}{\ln(x)} \,\overset{\text{L'H}}{=}\,
...
We get
\[\lim_{x \to 0^+}\frac{\ln(x)}{x^{-2}}\,\overset{\text{L'H}}{=}\, \lim_{x\to 0^+} \frac{1/x}{-2x^{-3}}\]
which simplifies to
