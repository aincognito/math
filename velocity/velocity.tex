...
\]
We will use $a = 0$, and to determine the value for $b$, we must know how long it takes for the object to hit the ground. To do this, we set $h(t) = 0$ and solve for $t$:
\[100-16t^2 = 0 \implies 16t^2 = 100 \implies t = \pm \sqrt{\frac{100}{16}} \implies t = \frac52\]
Thus the object hits the ground after $2.5$ seconds, and we can compute the average velocity of the object 
during the fall:
