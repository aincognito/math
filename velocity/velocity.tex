...
The height of a vertically free-falling object after $t$ seconds is given by $h(t) = 400 - 16t^2$ feet.
Find the average velocity of the object during the fall. \\
...
A negative velocity indicates that the object is \wordChoice{\choice{rising}
