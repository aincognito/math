...
To determine the velocity of an object at a particular moment in time, i.e., the \textbf{instantaneous velocity} of the object, we find the average velocity 
...
average velocities over the smallest time intervals, $-160$ft/sec would be a reasonable estimate 
...
several other progressively smaller time intervals.
