...
\draw[thin, dashed, gray] (3,1) -- (3,0) node[below, black] {5/2};

\draw[->, thick] (0,0) -- (0,4) node[left] {$s(t)$};
\filldraw (0,3) circle(.05) node[left] {$100$};
\filldraw (3,0) circle(.05) node[below] {$5/2$};
\draw[thin, blue] (0,3) --(3,0) node[midway,right] {$m = -40$ft/sec};

\node at (2,-1) {The slope of the blue line is the average velocity};
\node at (2, -1.5) {of the object from time $t = 0$ to time $t = 5/2$.};
