...
\[
x_1^* = -1,\;  x_2^* = -1/2,\; x_3^* = 0,\; \mbox{and}\; x_4^* = 1/2
\]
...
&= e^{1} (\frac12) + e^{1/2} (\frac12) + e^0 (\frac12) + e^{-1/2} (\frac12) \\
&\approx 2.987
\end{align*}

\begin{image}
\begin{tikzpicture}
\begin{axis}[axis x line=  bottom, axis y line = center, xtick={-1, -\tfrac12, 0, \tfrac12, 1},  
...
\begin{image}
\begin{tikzpicture}
\begin{axis}[axis x line=  bottom, axis y line = left, xtick={0, \tfrac15, \tfrac25, \tfrac35, \tfrac45, 1},  
