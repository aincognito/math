...
&= f(-1)\cdot \left(\tfrac12\right) + f(-1/2) \cdot \left(\tfrac12\right) +f(0) \cdot \left(\tfrac12\right) +f(1/2) \cdot \left(\tfrac12\right)\\
&= \left(\tfrac12\right)\left(e^{1}  + e^{1/2} \right) + \left(\tfrac12\right)\left( e^0 + e^{-1/2} \right) \approx 2.987
\end{align*}
...
\begin{align*}
\sum_{i=1}^4 f(x_i*)\Delta x &= f(x_1^*)\Delta x + f(x_2^*)\Delta x + f(x_3^*)\Delta x + f(x_4^*)\Delta x\\
&= f(-\tfrac12) \Delta x + f(0) \Delta x +f(\tfrac12) \Delta x +f(1) \Delta x\\
&= e^{\tfrac12} \left(\tfrac12\right) + e^0 \left(\tfrac12\right) + e^{-\tfrac12} \left(\tfrac12\right) +  e^{-1} \left(\tfrac12\right) \\
&\approx 1.812
\end{align*}
