...
If $m > 0$, then $f(x) = mx+b$ is increasing on the interval $(-\infty, \infty)$  and if $m < 0$, then it is decreasing on $(-\infty, \infty)$ .
...
In a prior example, we found that the critical numbers for $f(x)$ are $-2$ and $3$.  We also noted that
