...
xticklabels={$x_1$, $x_2$}, ytick={1.682, 2.828}, yticklabels={$f(x_1)$, $f(x_2)$}, title={$f(x)$ is increasing}]
...
xticklabels={$x_1$, $x_2$}, ytick={0.707, 0.3536}, yticklabels={$f(x_1)$, $f(x_2)$}, title={$f(x)$ is decreasing}]

\addplot[domain=-0.5:2, color=blue, thick]{1/2^x};
\addplot[dashed, gray] coordinates{(0.5, 0)  (0.5, 0.707)};
\addplot[dashed, gray] coordinates{ (0.5, 0.707) (0, 0.707)};
\addplot[dashed, gray] coordinates{(1.5, 0) (1.5, 0.3536)};
\addplot[dashed, gray] coordinates{(1.5, 0.3536) (0, 0.3536)};
\addplot[smooth,mark=*,blue] plot coordinates {(1.5, 0.3536)};
\addplot[smooth,mark=*,blue] plot coordinates {(0.5, 0.707)};
\end{axis}
%\addplot[mark=*,fill=white] coordinates {(0,0)}
\node at (4, -1) {$x_1 < x_2 \implies f(x_1) > f(x_2)$};				
\node[color=blue] at (-0.6, 4.2) {$y = f(x)$};
