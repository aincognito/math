...
\]
Thus the answer to the anti-differentiation problem is actually not just a single function but a family of functions each pair of which differing by a constant.
