...
\item $(x^3 + 1)^5$;  inside function: $g(x) = \answer{x^3 + 1}$ and outside function: $f(x) = \answer{x^5}$
\item $\ln(\cos(x))$; inside function: $g(x) = \answer{\cos(x)}$ and outside function: $f(x) = \answer{\ln(x)}$
\item $e^{\sqrt{x}}$; inside function: $g(x) = \answer{\sqrt{x}}$ and outside function: $f(x) = \answer{e^x}$
...
We have, 
\[
f'(x) = \frac{1}{2\sqrt{x}} \qquad \mbox{so,} \qquad f'(g(x)) = \frac{1}{2\sqrt{g(x)}} = \frac{1}{2\sqrt{x^2 + 9}} 
\]
