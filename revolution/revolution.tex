...
\definecolor{CCUteal}{RGB} {0,111,113}
\definecolor{CCUgold}{RGB} {169,119,82}

\outcome{Find the volume of a solid of revolution}

\title{2.2 Solids of Revolution}
%add in integral dy, and example of doing a particular region both ways
\begin{document}
...
\draw[thick, brown!40] (2,0) -- (2,2) ;



\filldraw[brown!40, thick] (6,1) circle(1);
\filldraw (6,1) circle(0.04);
\filldraw (2,0) circle(0.04);
\filldraw[brown] (2,2) circle(0.04);
\draw[brown] ((6,1) circle(1);
%\filldraw[brown] (2,2) circle(0.04);
...
%\draw[CCUteal] (0,0) -- (2,2);
%\draw[CCUgold] (2,2) -- (4,0);

\draw[ <->, thick] (0,0) -- (3.9,0) ;
\draw[thick, brown!40] (2, 1) -- (2, 2.5);
\node at (3, -1) {\begin{tabular}{c} The radii are the distances from the endpoints \\ of the vertical 
segment to the axis of revolution.\end{tabular}};


  
\filldraw[brown!40]  (6,1) circle (1) ;
\filldraw[white]  (6,1) circle (.5cm); 

\filldraw[fill=black] (6,1) circle (0.03cm);
\filldraw[fill=black] (2,0) circle (0.03cm);
\filldraw[teal] (2,1) circle (0.03cm);
\filldraw[brown] (2,2.5) circle (0.03cm);
\draw[teal, thick] (6,1) circle(.5);
\draw[brown, thick] (6,1) circle(1);
...
\draw[thick, brown!40] (2, 0) -- (2,2);
\filldraw[brown] (2,0) circle(.04);
\filldraw[teal] (2,2) circle (.04);
...
%\filldraw[brown!30] (6,2) ellipse (1.25 and 0.3);
\draw[teal, thick] (6,2) ellipse (1.25 and 0.3);
%\draw (6.75,1.2) -- (6.75,-1.2);
\draw[brown, thick] (4.75,0) arc (180:360:1.25 and 0.3);

%\draw (9.25,-1.2) -- (9.25,1.2) node[right,midway]{$h$};  
\fill [brown!40] (4.75,2) -- (4.75,0) arc (180:360:1.25 and 0.3) -- (7.25,2) arc (0:180:1.25 and -0.3);
%\filldraw[fill=black] (6,1.2) circle (0.03cm);
%\draw (8,1.2) -- (9.25, 1.2) node[midway,above, xshift=-.1cm, yshift=-.1cm]{$r$};
\draw [brown, dashed, thick] (4.75,0) arc (180:360:1.25 and -0.3) ;
...
\draw [draw=none, fill=brown!20] (0,0) -- (4,2) -- (4,0) -- cycle;
...
Find the formula for the volume of the frustum of the right, circular cone obtained by revolving the region 
...
\begin{image}
\begin{tikzpicture}
\filldraw[brown!20] (2,0) arc (0:180:2);
...
\]
\[
= \pi \left[\left(32 - \frac{64}{3} + \frac{32}{5}\right) - \left(-32 + \frac{64}{3} 
- \frac{32}{5}\right)\right] = \pi \left(64 - \frac{128}{3} + \frac{64}{5}\right)
=  \frac{512 \pi}{15}
\]
...
\begin{image}
\begin{tikzpicture}
\draw[name path = B, thick, domain=-2:2,smooth,variable=\x,brown] plot ({\x},{\x*\x}) node[brown] at (2,1.5) {$y=x^2$}; %curve #1
\draw[thick, name path = A] (-2, 4) -- (2, 4) node at (2, 4.3) {$y=4$}; %curve #2
%\fillbetween[of=A and B];
\fill [brown!20,
          intersection segments={
            of=A and B
          }];
\draw[name path = B, thick, domain=-2:2,smooth,variable=\x,brown] plot ({\x},{\x*\x}) node[brown] at (2,1.5) {$y=x^2$};
...
\begin{image}
\begin{tikzpicture}
\draw[name path = B, scale = 2, thick, domain=0:1.1,smooth,variable=\x,teal] plot ({\x},{3}) node at (0.7, 3.2) {$y = 3$};

\draw[name path = A, scale = 2, thick, domain=0:1.1,smooth,variable=\x,brown] plot ({\x},{e^\x}) node at (0.7, 1.4) {$y = e^x$};
\fill [brown!20,
          intersection segments={
            of=A and B
          }];
...
\filldraw[thick,brown!20]  (0, 6) -- (2.2,6) -- (0,2) -- (0,6); 
\draw[ scale = 2, thick, domain=0:1.1,smooth,variable=\x,white] plot ({\x},{e^\x});
        
\draw[scale = 2, thick, domain=0:1.1,smooth,variable=\x,brown] plot ({\x},{e^\x}) node at (0.7, 1.4) {$y = e^x$};
\draw[thick,teal]  (0, 6) -- (2.2,6);           
...
Find the volume of the solid obtained by revolving the region between $y= \frac{1}{x}$ 
and $y = 1$ from $x = 1$ to $x = 2$ about the $x$-axis. Include a rough sketch of the region being revolved.\\
...
Find the volume of the solid obtained by revolving the region between $y= \sqrt[3] x$ 
and $y = 1$ from $x = 0$ to $x = 1$ about the $x$-axis. Include a rough sketch of the region being revolved.\\
...
Find the volume of the solid obtained by revolving the region between $y= x$ 
and $y = x^2$ from $x = 0$ to $x = 1$ about the line $y = 1$. Include a rough sketch of the region being revolved.\\
...
\begin{example}[example 7] Find the volume of the solid obtained by revolving the region bounded by the 
graphs of $y = x^2, y=0$, 
...
\begin{image}
            \begin{tikzpicture}
                ...
                \addplot [domain=0:3.1,very thick,smooth] {x^2-4};
            \addplot [very thick,smooth] {5};
            \addplot [very thick,smooth] coordinates {(1,-10)(1,10)};
                \addplot [very thick,dashed] coordinates {(0,-10)(0,10)};
            ...
            \addplot [fillp] fill between[of=C and A];
             ...
             \addplot [draw=black,fill=gray!50,thick] coordinates {(1,2)(2.45,2)(2.51,2.3)(1,2.3)(1,2)};
                ...
                \node at (axis cs:2.5,6.3)  {$x=\sqrt{y+4}$};
                \node at (axis cs:-1.5,5.5)  {$y=5$};
        \node at (axis cs:1.55,5.5)  {$x=1$};
