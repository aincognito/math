...
The radius of the disk at $x$ is $r = \answer{(2x+1)^2}$\\
...
\]
The volume of the solid can be otained by integrating the area of a cross-section as $x$ ranges from $0$ to $\ln 3$:
\[
...
\]
The volume of the solid can be otained by integrating the area of a cross-section as $x$ ranges from 0 to $\pi/4$:
\[
...
\]
The volume of the solid can be otained by integrating the area of the shells as $x$ ranges from 0 to 1:
\[
