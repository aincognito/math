...
Find the volume of the solid obtained by revolving the region bounded by the lines $y=2x, y=0$ and $x=3$ about the $x$-axis.\\
The solid of revolution in this case is a cone. To begin, we draw a vertical line segment in the region at $x$-coordinate $x$. Revolving this segment about the axis of revolution (the $x$-axis) creates a disk.  The area of this disk is
\[
A = \pi r^2,
\]
...
\[
V = \int_a^b \text{(area)} \; dx = \int_0^3 \pi r^2 \, dx = \int_0^3 \pi (2x)^2 \, dx.
\]
Computing this integral gives
\[
V = 4\pi \int_0^3 x^2 \, dx = 4\pi \cdot \frac{x^3}{3} \bigg |_0^3 = 4\pi(9-0) = 36\pi.
\]


\begin{image}
\begin{tikzpicture}
\draw[ <->, thick] (0,6.5) -- (0,0) -- (3.9,0);

\draw[thick, domain=0:3,smooth,variable=\x,brown] plot ({\x},{2*\x}) node at (1.5, 4.4) {$y = 2x$};

\draw[thick, brown] (3,0) -- (3,6) node at (3.5,3) {$x = 3$};
\draw[thick, teal] (6,3) -- (7.5,3);
\draw[thick, teal] (1.7,0) -- (1.7,3.4);
\draw[thin] (1.7, 0.05) -- (1.7, -0.05) node[below] {$x$};
\draw[thin] (3, 0.05) -- (3, -0.05) node[below] {$3$};

\draw[brown, thick] (6,3) circle(1.5);
\filldraw (6,3) circle(0.04);
