...
In this section, we present the derivatives of the functions introduced earlier.  
...
The following table lists the chain rule versions of the above basic derivative formulas.
...
The following table is an alternative version of the above chain rule formulas  
