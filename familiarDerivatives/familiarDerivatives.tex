...
\begin{array}{c|c|c}
		...
		\hline
		\text{Trig} & \sin(g(x)) & \cos(g(x)) \cdot g'(x) \\[6pt]
		\text{Trig} & \cos(g(x)) & -\sin(g(x))\cdot g'(x)  \\[6pt]
		\hline
		\text{Trig} & \tan(g(x)) & \sec^2(g(x)) \cdot g'(x) \\[6pt]
		\text{Trig} & \sec(g(x)) & \sec(g(x))\tan(g(x)) \cdot g'(x) \\[6pt]
		\hline
		\text{Trig} & \cot(g(x)) & -\csc^2(g(x)) \cdot g'(x)  \\[6pt]
		\text{Trig} & \csc(g(x)) & -\csc(g(x))\cot(g(x)) \cdot g'(x)  \\[6pt]
		\hline
		\text{Inv Trig} & \sin^{-1}(g(x)) & \displaystyle{\frac{1}{\sqrt{1-g^2(x)}}} \cdot g'(x) = \frac{g'(x)}{\sqrt{1-g^2(x)}}  \\[6pt]
		\text{Inv Trig} & \cos^{-1}(g(x)) & \displaystyle{-\frac{1}{\sqrt{1-g^2(x)}}} \cdot g'(x) = -\frac{g'(x)}{\sqrt{1-g^2(x)}}\\[6pt]
		\text{Inv Trig} & \tan^{-1}(g(x)) & \displaystyle{\frac{1}{1+g^2(x)}} \cdot g'(x) = \frac{g'(x)}{1+g^2(x)} \\
		\hline
		\text{Exponential} & e^{g(x)} & e^{g(x)} \cdot g'(x) \\[6pt]
		\text{Exponential} & a^{g(x)} & a^{g(x)}\ln(a) \cdot g'(x) \\[6pt]
		\hline
		\text{Log} & \ln(g(x)) & \displaystyle{\frac{1}{g(x)}}\cdot g'(x) = \frac{g'(x)}{g(x)} \\[6pt]
		\text{Log} & \log_a(g(x)) & \displaystyle{\frac{1}{g(x)\ln(a)}}\cdot g'(x) = \frac{g'(x)}{g(x)\ln(a)}
	\end{array}
    \]
\end{center}
