...
Determine whether the geometric series converges or diverges. If it converges, find its sum: $\;\;\dis \sum_{k=0}^\infty \left(\frac{2i}{2+i}\right)^k$ \\
...
b) $\dis\; \{c_k\} = \{1, -1, \frac12, -1, \frac13, -1, \ldots\} \quad \limsup_{k\to\infty} c_k = \; \answer{0}$\\
\end{problem}
...
\]
$\left|\frac{c_{k+1}}{c_k}\right| = \; \answer{\frac{1}{(2k+2)(2k+1)}}$\\
