...
\begin{image}
\begin{tikzpicture}
\node at (-0.5,1.25) {Sign of $f''(x)$};

\node at (-1.5, .5) {- - - - -};
\node at (0.5, .5) {+++};
\draw[thin, white] (-3.5, 0) --(2.5,0);
...
\begin{image}
\begin{tikzpicture}
\node at (-.75,1.25) {Sign of $f''(x)$};

\node at (-1.8, .5) {+++};
\node at (-0.65, .5) {- - - -};
\node at (0.5, .5) {+++};
\draw[thin, white] (-3.75, 0) --(2.25, 0);
...
\begin{image}
\begin{tikzpicture}
\node at (0,1.25) {Sign of $f''(x)$};

\node at (-1.6, .5) {+++};
\node at (0, .5) {- - - -};
\node at (1.6, .5) {+++};
\draw[thin, white] (-3, 0) --(3, 0);
