...
say that $x = \pm \frac{1}{\sqrt 2} 2$ are inflection points for $f(x) = e^{-x^2}$.
...
\choice{$(0, \infty)$}
\choice{$(-\infty, 0)$}
\choice[correct]{$(2, \infty)$}
\choice{$(-\infty, \infty)$}
\choice[correct]{$(-\infty, -2)$}
\end{selectAll}
...
\begin{selectAll}
\choice[correct]{local maximum at $x = -2$}
\choice{local maximum at $x = 2$}
\choice{local minimum at $x = 0$}
\choice{local minimum at $x = -2$}
\choice[correct]{local minimum at $x = 2$}
\end{selectAll}
...
\begin{selectAll}
\choice[correct]{inflection point at $x = -2$}
