...
To find the particular solution, we substitute $x= 0$ and $y = 1$ into the general solution to find a value for $C$:
\[
1 = -\frac{2}{0^2 + C}
\]
...
\begin{multipleChoice}
\choice[correct]{$\displaystyle{y = \pm \sqrt[4]{2x^3 + C}}$}
\choice{$\displaystyle{y = \pm\sqrt[4]{4x^3 + C}}$}
...
\choice{$\displaystyle{0.025A +  \, dA = 0.15\, dt}$}
