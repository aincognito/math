...
$\displaystyle \lim_{n\to \infty} \frac{1}{3^n} = \;\;\answer{0}$ \;\;
...
$\displaystyle \lim_{n\to \infty} \frac{2^{2n}}{3^n} = \;\;\answer{\infty}$ \;\;
...
$\displaystyle \lim_{n\to \infty} \frac{\ln n}{n} = \;\;\answer{0}$ \;\;
The sequence \wordChoice{\choice[correct]{converges}\choice{diverges}}
\end{problem}
...
$\displaystyle \lim_{n\to \infty} \frac{n^2}{5n+4} = \;\;\answer{\infty}$ \;\;
The sequence \wordChoice{\choice{converges}\choice[correct]{diverges}}
\end{problem}
...
$\displaystyle \lim_{n\to \infty} \frac{(-1)^n}{n} = \;\;\answer{0}$ \;\;
The sequence \wordChoice{\choice[correct]{converges}\choice{diverges}}
\end{problem}
...
$\displaystyle \lim_{n\to \infty} \cos(n\pi) = \;\;\answer{DNE}$ \;\;
The sequence \wordChoice{\choice{converges}\choice[correct]{diverges}}
\end{problem}
...
\begin{problem} Determine whether the sequence is increasing, decreasing or neither.
\begin{align*}
a) \;\; & \left\{\frac{1}{\sqrt n}\right\} \quad \mbox{\wordChoice{\choice{increasing} \choice[correct]{decreasing} \choice{neither}}}  \\
b) \;\; &  \left\{\frac{n}{n^2 +1}\right\} \quad \mbox{\wordChoice{\choice{increasing} \choice[correct]{decreasing} \choice{neither}} } \\
c) \;\; &  \left\{\ln n\right\} \quad \mbox{\wordChoice{\choice[correct]{increasing} \choice{decreasing} \choice{neither}} } \\
d) \;\; &  \left\{\frac{\cos(n\pi)}{n^2}\right\} \quad \mbox{\wordChoice{\choice{increasing} \choice{decreasing} \choice[correct]{neither}} } \\
e) \;\; &  \left\{\frac{n^2 + 1}{n^3 + 1}\right\} \quad \mbox{\wordChoice{\choice{increasing} \choice[correct]{decreasing} \choice{neither}}} 
\end{align*}
\end{problem}
