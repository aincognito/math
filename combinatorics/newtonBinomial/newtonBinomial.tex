...
\wordChoice{\choice[correct]{overestimate}\choice{underestimate}}  Maximum error: $\; \answer{}$\\
b) Approximate: $\sqrt{10}$. Truncate your infinite series at $k = 3$ \\ 
Approximation: $\; \answer{}$ Nature of estimate? \wordChoice{\choice[correct]{overestimate}\choice{underestimate}}
