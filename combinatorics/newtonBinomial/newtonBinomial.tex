...
\wordChoice{\choice[correct]{over-extimate}\choice{under-estimate}}  Maximum error: $\; \answer{}$\\
b) Approximate: $\sqrt{10}$. Truncate your infinite series at $k = 3$ \\ 
Approximation: $\; \answer{}$ Nature of estimate? \wordChoice{\choice[correct]{over-extimate}\choice{under-estimate}}
Maximum error: $\; \answer{}$\\
c) Approximate $\sqrt{2}$. Truncate your infinite series at $k = 4$ \\ Approximation: $\; \answer{}$ Nature of estimate? \wordChoice{\choice[correct]{over-extimate}\choice{under-estimate}}
Maximum error: $\; \answer{}$\\
