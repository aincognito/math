...
C_{n+1} &= (n+1)! \sum_{k=0}^{n} (-1)^k \frac{1}{(n-k+1 ) k!} + (-1)^{n+1} \\
        &= n! + (n+1)!\sum_{k=1}^{n} (-1)^k \frac{1}{(n-k+1 ) k!} + (-1)^{n+1}\\
        &= n! + (n+1)!\sum_{k=0}^{n-1} (-1)^{k+1} \frac{1}{(n-k ) (k+1)!} + (-1)^{n+1}\\
        & = n! + \sum_{k=0}^{n-1} (-1)^{k+1} \frac{(n+1)!}{(n-k ) (k+1)!} + (-1)^{n+1}\\
        & = n! + \sum_{k=0}^{n-1} (-1)^{k+1} \frac{(n+1)!}{(n-k)! (k+1)!} (n-k-1)!+ (-1)^{n+1}\\
        & = n! + \sum_{k=0}^{n-1} (-1)^{k+1} \binom{n+1}{k+1} (n-k-1)! + (-1)^{n+1}
\end{align*}
...
\[
C_n + C_{n+1} = n! \sum_{k=0}^{n-1} (-1)^k \frac{1}{(n-k) k!} + 
