...
A relative derangement of a permutation is another permutation in which each object in the first 
permutation has a different successor. The number of relative derangements of a permutation consisting 
of $n$ elements is denoted by $Q_n$.
\end{definition}

\begin{remark}
In its simplest form, a relative derangement of the permutation $123...n$ is a permutation which does not contain any of the strings $12, 23, 34, ..., (n-1)n$.
\end{remark}
...
The number of relative derangements of the permutation $123...n$, i.e., the number of permutations of the set $S = 1, 2, 3, ..., n$ which do not contain any of the strings $12, 23, 34, ..., (n-1)n$, is given by
\[
...
\begin{problem}(problem 3)  Show that for $k \geq 1$
\[
