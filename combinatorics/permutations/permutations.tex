...
\outcome{Define and ennumerate permutations}

\title{1.3 Permutations}

\begin{document}

\begin{abstract}
We define and ennumerate permutations.
\end{abstract}
...
positions be filled?\\
The selection of class officers can be thought of as a permutation since we are selecting 4 students and 
the order of their selection is significant since it determines which office they will hold. Thus we seek the number of permutation of 24 objects taken 4 at a time, i.e., $P(24, 4)$. By the fundamental principle of counting, this is
\[
