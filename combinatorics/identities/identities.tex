...
On the other hand, we can create all the possible subsets of $S$ by partitioning them 
...
\]
The right-hand side counts the number of ways to form a committee of $r+1$ people from a group of $n+1$ people.
