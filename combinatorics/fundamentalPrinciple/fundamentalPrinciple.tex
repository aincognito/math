...
Pat has three different shirts and two different pairs of pants. Getting dressed requires one of each.  
...
\draw[blue!20!white, draw=blue] (0, 0, 0) -- (5, 0, 0) -- (5, 0, 2) -- (0, 0, 2) -- (0, 0, 0);
\draw[red!50!white, fill] (4, 0, 1) circle (0.05) node[right, red!80!white]{$Q$};
\draw[red!70!white, -&gt;] (4, 0, 1) -- (4, 0, 4) node[right]{$\vec{n}$};
\draw (3.6, 0, 1) -- (3.6, 0, 1.4) -- (4, 0, 1.4);
\node[blue] at (5, 0, 1){$P$};
\node at (3.5, -1, 1.5) {The vector $\vec{n}$ is normal to the plane $P$ at the point $Q$};
\end{tikzpicture}
