...
\begin{remark}
The assummption that $f(x)$ and $g(x)$ are positive is unnecessary due to the folling line of reasoning. 
...
The top curve is $y = \answer{x^2 + 2}$ and\\
the bottom curve is $y = \answer{1}$.\\
The definite integral that represents this area is $\int_0^{3} \answer{x^2 + 1} \; dx$\\
...
The top curve is $y = \answer{2e^x}$ and\\
the bottom curve is $y = \answer{\cos(x)}$.
The definite integral that represents this area is $\int_0^{\pi/2} \answer{2e^x - \cos(x)} \; dx$\\
...
The top curve is $y = \answer{e^{2x}}$ and\\
the bottom curve is $y = \answer{\sin(3x)}$.
The definite integral that represents this area is $\int_0^{\pi/3} \answer{e^{2x} - \sin(3x)} \; dx$\\
...
The top curve is $y = \answer{x^2}$ and\\
the bottom curve is $y = \answer{x - 2}$.
The definite integral that represents this area is $\int_0^2 \answer{x^2 - x + 2} \; dx$\\
...
The top curve is $y = \answer{(3x+2)^3}$ and\\
the bottom curve is $y = \answer{1-x^2}$.
The definite integral that represents this area is $\int_0^1 \answer{(3x+2)^3  + x^2 - 1} \; dx$\\
The area of the region is $\answer{601/12}$.
\end{problem}

\section{Intersecting Curves}
In this section, one or both of the endpoints of integration will be a point of intersection of the curves forming the topa nd bottom 
...
The top curve is $y = \answer{\sin(x)}$ and\\
the bottom curve is $y = \answer{\cos(x)}$.\\
The definite integral that represents this area is $\int_{\pi/4}^{5\pi/4} \answer{\sin(x) - \cos(x)} \; dx$\\
...
The definite integral that represents this area is $\int_{-2}^2 \answer{8 - 2y^2} \; dy$\\
