...
\end{abstract}
%add in ln x curve where the dy integral is necessary (or need integral of ln x)
\maketitle
...
\choice{$\dis \int_0^3 (-1-x^2)\; dx$}\\
\choice{$\dis \int_0^3 (x^2 - 1) \; dx$}\\
\choice[correct]{$\dis \int_0^3 (x^2 + 1) \; dx$}\\
\end{multipleChoice}
...
\begin{multipleChoice}
\choice{$\dis \int_0^2 (-x^2 +x -2)\; dx$}\\
\choice{$\dis \int_0^2 (x^2 +x - 2) \; dx$}\\
\choice[correct]{$\dis \int_0^2 (x^2 -x + 2) \; dx$}\\
\end{multipleChoice}
...
\begin{multipleChoice}
\choice{$\int_0^1 \left[(2x+1)^2  -(2x+1)^3\right]\; dx$}\\
\choice[correct]{$\int_0^1 \left[(2x+1)^3  -(2x+1)^2\right] \; dx$}\\
\choice{$\int_0^1 (2x+1) \; dx$}\\
\end{multipleChoice}
