...
Combining this with a clever subtrsaction, we can find the area between two curves.
...
\node at (axis cs: 2,3.5){$f(x)=5-x^2$};
\node at (axis cs: 2,-3.1){$g(x)=x-4$};
%\node at (axis cs: 0.2,1.25){$y = f(x)$};
...
\node at (axis cs: 1.5,-3.5){$g(x)=x^2+x-3$};
%\node at (axis cs: 0.2,1.25){$y = f(x)$};
