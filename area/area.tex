...
\node at (axis cs: 1.4,-4.8){$\displaystyle{A=\int_{a}^{b} \left[f(x)-g(x)\right]\; dx=\frac{31}{6}}$};
...
\node at (axis cs: 0,-1.5){$\displaystyle{A=\int_{a}^{b} \left[f(x)-g(x)\right]\; dx=\frac{1}{3}}$};
...
\node at (axis cs: 1.3,-2){$\displaystyle{\text{Area}=2\sqrt2}$};
