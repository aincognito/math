...
The partial derivative of $f(x,y)$ with respect to $x$, denoted $f_x(x,y)$ or $\ppx f(x,y)$, is defined by
\[
f_x(x,y)= \lim_{h \to 0} \frac{f(x+h, y) -f(x, y)}{h}
\]

The partial derivative with respect to $y$, denoted $f_y(x,y)$ or $\ppy f(x,y)$, is defined by
...
The symbols $\ppx$ and $\ppy$ are called partial derivative operators.
