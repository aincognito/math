...
\draw[thin] (0.7 ,0.7) arc (45:150: 1) node[pos=0.85, above = 2pt]{$\alpha - \beta$};
...
\begin{proposition}
Given two non-zero vectors in $\R^2$, $\vec{v}_1 = \vector{x_1, y_1}$ and $\vec{v}_2 = \vector{x_2, y_2}$, 
thier dot product can be expressed as
\[
...
then either
\[
|\vec{v}_1| = 0 \; \text{or } |\vec{v}_2| = 0 \; \text{or } \; \cos \theta = 0
\]
