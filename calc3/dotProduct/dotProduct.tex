...
We now see how the dot product relates to the angle between two vecors. 
To do this, we compute the dot product between two unit vectors that are given in polar form.
Let $\vec{u}_1 = \vector{\cos \alpha, \sin \alpha}$ and $\vec{u}_2 = \vector{\cos \beta, \sin \beta}$ then
\[
...
\draw[thin] (0.75 ,0.75) arc (45:150: 0.9) node[pos=0.75, above]{$\alpha - \beta$};
