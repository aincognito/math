...
\draw[thin] (0.5 ,0.5) arc (45:150: 0.9) node[pos=0.75, above]{$\alpha - \beta$};
\draw[blue, thin] (0.3, 0) arc (0:150: 0.45) node[pos=0.75, above]{$\alpha$};
\draw[red, thin] (0.5, 0) arc (0:45: 0.65) node[pos=0.75, right]{$\beta$};
