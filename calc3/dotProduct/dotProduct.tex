...
In the next example, we will use the inverse cosine function on the dot product to find the angle btween two vecotrs.
Note that the inverse cosine always outputs and angle in the afforementioned interval.
