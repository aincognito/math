...
\]
then the dot product $\vec{v}_1 \pmb{\boldsymbol \cdot} \vec{v}_2$ is defined by
\[
...
\begin{align*}
\vec{v}_1 \cdot \vec{v}_2 & = \left(|\vec{v}_1| \vector{\cos \alpha, \sin \alpha}\right) \dotp \left( |\vec{v}_2| \vector{\cos \beta, \sin \beta} \right)\\
