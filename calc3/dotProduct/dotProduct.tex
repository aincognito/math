...
To see the relationship between the dot product and the angle between the vectors, compute the dot product of these generic unit vectors:
\[\vector{\cos \alpha, \sin \alpha} \dotp \vector{\cos \beta, \sin \beta}  =\]
\begin{hint}
...
\choice{$\sin\left(\alpha + \beta\right)$}
\choice{$\sin\left(\alpha - \beta\right)$}
\choice{$\cos\left(\alpha + \beta\right)$}
\choice[correct]{$\cos\left(\alpha - \beta\right)$}
\end{multipleChoice}
