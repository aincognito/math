...
\draw[thin] (0.7 ,0.7) arc (45:150: 1) node[pos=0.75, above]{$\alpha - \beta$};
\draw[blue, thin] (0.45, 0) arc (0:150: 0.45) node[pos=0.75, above]{$\alpha$};
\draw[red, thin] (0.65, 0) arc (0:45: 0.65) node[pos=0.75, right]{$\beta$};
...
The dot product of a vector with itself yields a useful result.  Let $\vec{v} = \vector{x, y}$. Then
\[
\vec{v} \dotp \vec{v} = x^2 + y^2 = |\vec{v}|^2
\]
Hence, the dot product of a vector with itself is the square of its magnitude.
