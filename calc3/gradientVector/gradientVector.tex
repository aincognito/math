...
Here is a video solution of problem 6a:\\
\begin{foldable}
\youtube{dXyZfGBDCIM}
\end{foldable}
...
\[
\vec u = \vector{\answer{1/2}, \answer{\sqrt{3} /2}}
\]
The directional derivative is
\[
...
\[
D_{\vec u} T(0,0) = \answer{8/ \sqrt 5} \; ^\circ \text{F / inch}
\]
\end{problem}
...
\[
|\grad f(4,6)| = \sqrt{\frac13 + \frac34} = \frac{\sqrt{39}}{6}
\]
\end{example}
