...
\begin{align*}
\frac{d}{dt}\left[f(t)\vec r(t)\right] &= \frac{d}{dt} \left[ \vector{f(t)x(t), f(t)y(t),f(t)z(t)}\right]\\[6pt]
&=  \vector{\frac{d}{dt} \left[f(t)x(t)\right], \frac{d}{dt} \left[f(t)y(t)\right],\frac{d}{dt} \left[f(t)z(t)\right]}\\[6pt]
&= \vector{f(t)x'(t) + f'(t)x(t), f(t)y'(t) + f'(t)y(t), f(t)z'(t) + f'(t)z(t)}\\[6pt]
&=\vector{f(t)x'(t) , f(t)y'(t), f(t)z'(t)}+ \vector{f'(t)x(t), f'(t)y(t), f'(t)z(t)}\\[6pt]
&= f(t)\vector{x'(t), y'(t), z'(t)} + f'(t)\vector{x(t), y(t), z(t)}\\[6pt]
...
\begin{align*}
\frac{d}{dt}\left[\vec r_1(t) \dotp \vec r_2(t)\right] &= \frac{d}{dt} \left[ x_1(t)x_2(t)+ y_1(t)y_2(t)+ z_1(t)z_2(t)\right]\\[6pt]
&=  \frac{d}{dt} \left[x_1(t)x_2(t)\right]+ \frac{d}{dt} \left[y_1(t)y_2(t)\right]+\frac{d}{dt} \left[z_1(t)z_2(t)\right]\\[6pt]
&= x_1(t)x_2'(t) +x_1'(t)x_2(t)+ y_1(t)y_2'(t) +y_1'(t)y_2(t)+ z_1(t)z_2'(t) +z_1'(t)z_2(t)\\[6pt]
&= \left[x_1(t)x_2'(t) + y_1(t)y_2'(t)+ z_1(t)z_2'(t)\right] + \left[x_1'(t)x_2(t)+ y_1'(t)y_2(t)+ z_1'(t)z_2(t)\right]\\[6pt]
&= \vector{x_1(t), y_1(t), z_1(t)}\dotp \vector{x_2'(t), y_2'(t), z_2'(t)} + \vector{x_1'(t), y_1'(t), z_1'(t)}\dotp \vector{x_2(t), y_2(t), z_2(t)}\\[6pt]
...
Let $\vec r_1(t) = \vector{ \cos 3t, \sin 3t, \sqrt t}$ and  $\vec r_2(t) = \vector{ e^{2t}, \ln t, \frac{1}{t}}$. Find
\[
\frac{d}{dt} \vec r_1(t) \dotp \vec r_2(t).
\]
...
\end{corollary}
\begin{proof}
The magnitude of the unit tangent vector, $\vec T(t)$, is one, and hence constant. The result then follows from the previous proposition.
\end{proof}

\begin{problem}(Problem 2)
Find $\vec T(t)$ and $\vec T\,'(t)$ for the helix: $\displaystyle \vec r(t) = \vector{\cos 3t, \sin 3t, 4t}$.\\
Verify the above corollary by showing that $\vec T(t) \dotp \vec T\,'(t) = 0$.
\end{problem}
...
\begin{align*}
\frac{d}{dt}\left[\vec r_1(t) \cross \vec r_2(t)\right] &= \frac{d}{dt} \left[ \vector{y_1z_2 - z_1y_2, z_1x_2 - x_1z_2, x_1y_2 - y_1x_2}\right]\\[6pt]
&=  \vector{\frac{d}{dt} \left[y_1z_2 - z_1y_2\right], \frac{d}{dt} \left[z_1x_2 - x_1z_2\right],\frac{d}{dt} \left[x_1y_2 - y_1x_2\right]}\\[6pt]
&= \vector{y_1z_2' + y_1'z_2- z_1y_2'  - z_1'y_2,  z_1x_2' + z_1'x_2- x_1z_2'  - x_1'z_2, x_1y_2' +x_1'y_2- y_1x_2'  - y_1'x_2      }\\[6pt]
&=\vector{y_1z_2' - z_1y_2'  ,  z_1x_2' - x_1z_2', x_1y_2' - y_1x_2'}+ \vector{ y_1'z_2  - z_1'y_2, z_1'x_2 - x_1'z_2, x_1'y_2 - y_1'x_2}\\[6pt]
&= \vector{x_1, y_1, z_1}\cross \vector{x_2', y_2', z_2'} + \vector{x_1', y_1', z_1'}\cross \vector{x_2, y_2, z_2}\\[6pt]
...
\begin{align*}
\frac{d}{dt} \vec r(g(t)) &= \frac{d}{dt} \vector{x(g(t)), y(g(t)),z(g(t))}\\[6pt]
&= \vector{\frac{d}{dt} x(g(t)), \frac{d}{dt} y(g(t)), \frac{d}{dt} z(g(t))}\\[6pt]
&= \vector{x'(g(t)) g'(t), y'(g(t)) g'(t), z'(g(t)) g'(t)}\\[6pt]
&= g'(t)\vector{x'(g(t)), y'(g(t)), z'(g(t))}\\[6pt]
&= g'(t) \vec r\,'(g(t))
\end{align*}
as claimed.
\end{proof}
