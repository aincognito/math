...
We next look at an extension of the previous chain rule to the case  where $x$ and $y$ are themselves functions of two variables.
...
\]
where $z_x$ and $z_y$ are each functions of both $x$ and $y$. By the chain rule, we have
\begin{align*}
