...
one possible parameterization of the line segment is
\[
...
An alternative method for parameterizing a line segment was discussed in chapter 1: if $P$ and $Q$ are the vector representation of points, then the line segment from 
$P$ to $Q$ is:
\[
...
by this force as the object moves in a semicircle from the point $(0, 3)$ to the point $(0, -3)$.\\
\[
\text{Work} = \answer{0}
\]
