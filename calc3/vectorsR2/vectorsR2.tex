...
%\node at (-0.3,2){$2$};
%\node at (-0.3, -2){$-2$};
\node at (0, -3) {Multiple copies of the vector $\vector{1,1}$};
\end{tikzpicture}
\end{image}
...
\draw[thick,->, blue] (0,0) -- (1, 0) node[above ]{$\vec{i}$};
\draw[thick,->, blue] (0,0) -- (0,1) node[right]{$\vec{j}$};
...
The vector with initial point $P(x_1, y_1)$ and final point $Q(x_2, y_2)$ has components $\vec{PQ} = \vector{x_2 - x_1, y_2-y_1}$


\begin{image}
\begin{tikzpicture}
\draw[ <->] (-2,0) -- (2, 0) node[right]{$x$};
\draw[ <->] (0,-1) node[below]{The vector $\vec{PQ} = \vector{x_2 - x_1, y_2-y_1}$} -- (0, 2) node[above]{$y$};
...
The components of $\vec{PQ}$ are $\vector{1-(-2), 1-3} = \vector{3, -2}$.
...
\node at (-0.3,2){$2$};
\node at (-0.3, -2){$-2$};
\node at (0, -3.8) {Two copies of the vector $\vec{PQ} = \vector{3,-2}$};
\end{tikzpicture}
\end{image}
...
\draw[thick, <->] (-3.5,0) -- (3.5, 0) node[right]{$x$};
\draw[thick, <->] (0,-3.5) -- (0, 3.5) node[above]{$y$};
\draw[->, blue, thick] (0,0) -- (-2.5, 2.5) node[above, right]{$\vec{v} = \vector{|\vec{v}|\cos\theta,|\vec{v}|\sin\theta}$};
\draw[blue, fill] (0, 0) circle (0.03);
...
\draw[red, ->] (3,2) -- (3, 2.5) node[above]{normal force, $\vec{N}$};
...
\draw[red, ->] (0,0) -- (6.8, 4) node[midway, above left]{$|\vec{r}| = 24$};
...
\draw[red, ->] (0,0) -- (0, -1) node[below]{W\\vec{w} = \vector{0, -20}};
\draw[red, <-] (1, 1) node[left]{friction = $8$N} -- (1.5,1);
...
\begin{tikzpicture}
\draw[blue, thick, ->] (-3,0) -- (-2,0) node[right]{$\vec{v}$};
\draw[blue, thick, <-] (-3,-0.5) node[left ]{$-\vec{v}$} -- (-2,-0.5) ;
\draw[red, thick, ->] (0,-1) -- (2,-1) node[right]{$2\vec{v}$};
\draw[red, thick, <-] (0,-1.5) node[left]{$-2\vec{v}$} -- (2,-1.5);
\draw[green, thick, ->] (0,-2) -- (0.5,-2) node[right]{$\tfrac12\vec{v}$};
\draw[green, thick, <-] (0,-2.5)node[left]{$-\tfrac12\vec{v}$} -- (0.5,-2.5) ;
