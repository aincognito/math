...
\[
s = \int_0^t |\vec r\,'(u)| \, du = \int_0^t \sqrt{ (-R\sin u)^2 + (R\cos u)^2 + 0^2} \, dt = \int_0^t R \, dt = Rt
\]
Hence 
\[
t = f^{-1}(s) = \frac{s}{R}
...
Compute the curvature of the helix $\vec r(t) = \vector{2\cos(3t), 2 \sin(3t), 5t}$.\\
The arc length parameter is given by
\[
s = \int_0^t \sqrt{\left(-6\sin(3u) \right)^2+\left(6\cos(3u) \right)^2 + 25} \, du = \int_0^t \sqrt{61} \, du = t\sqrt{61}
\]
...
Compute the curvature of helix $\vec r(t) = \vector{4t, 5 \sin(2t),5\cos(2t)}$ using the method of example 3.\\
...
%\begin{align*}
%\vec T(t) &= \frac{\vec r\,'(t)}{|\vec r\,'(t)|}\\[10pt]
%             &= \vector{\frac{e^t}{e^t + e^{-t}}, \frac{\sqrt 2}{e^t + e^{-t}} , \frac{e^{-t}}{e^t + e^{-t}}}\\[10pt]
...
%\begin{align*}
%\left|\vec T\,'(t)\right| &= \frac{e^t}{\left(e^{2t} +1\right)^2} \sqrt{4e^{2t} + 2 (1 - e^{2t})^2 + 4e^{2t}}\\[10pt]
 %         &= \frac{e^t}{\left(e^{2t} +1\right)^2} \sqrt{8e^{2t} + 2 (1 -2e^{2t}+ e^{4t})}\\[10pt]
 %       &= \frac{e^t \sqrt 2}{\left(e^{2t} +1\right)^2} \sqrt{4e^{2t} +  (1 -2e^{2t}+ e^{4t})}\\[10pt]
 %         &= \frac{e^t \sqrt 2}{\left(e^{2t} +1\right)^2} \sqrt{1 +2e^{2t}+ e^{4t}}\\[10pt]
 %         &= \frac{e^t \sqrt 2}{\left(e^{2t} +1\right)^2} \sqrt{(1 +e^{2t})^2}\\[10pt]
...
%\begin{align*}
%\kappa &= \frac{|\vec T\,'(t)|}{|\vec r\,'(t)|}\\[10pt]
 %      &= \frac{e^t \sqrt 2}{e^{2t} +1} \cdot \frac{1}{e^t + e^{-t}}\\[10pt]
 %     &= \frac{e^t \sqrt 2}{e^{2t} +1} \cdot \frac{e^t}{e^{2t} + 1}\\[10pt]
...
Next, we compute the unit tangent vector:
\[
\vec T(t) = \frac{\vec r\,'(t)}{|\vec r\,'(t)|} = \vector{\frac{e^t}{e^t + e^{-t}}, \frac{\sqrt 2}{e^t + e^{-t}} , \frac{-e^{-t}}{e^t + e^{-t}}}\\[10pt]
\]
  Note that the difference between the first and third components is 1. This implies that their derivatives are equal!          

We use the quotient rule on each component to calculate the derivative of the unit tangent vector. The reader should verify that
\[
\vec T\,'(t) = \frac{1}{\left(e^{t} +e^{-t}\right)^2} \vector{2, \sqrt 2 (e^t - e^{-t}), 2} 
\]
Next, the magnitude of the derivative of the unit tangent vector is
\begin{align*}
\left|\vec T\,'(t)\right| &= \frac{1}{\left(e^{t} +e^{-t}\right)^2} \sqrt{4 + 2 (e^t - e^{-t})^2 + 4}\\[10pt]
          &= \frac{1}{\left(e^{t} +e^{-t}\right)^2} \sqrt{2(e^{t} +e^{-t})^2} \qquad\text{(Verify)}\\[10pt]
            &= \frac{ \sqrt 2}{e^{t} +e^{-t}}
\end{align*}
Finally, we obtain the curvature $\kappa$:
\begin{align*}
\kappa &= \frac{|\vec T\,'(t)|}{|\vec r\,'(t)|}\\[10pt]
       &= \frac{ \sqrt 2}{e^{t} +e^{-t}} \cdot \frac{1}{e^t + e^{-t}}\\[10pt]
...
0 & 2 & 6t
\end{vmatrix}\\[10pt]
&= (12t^2 - 6t^2) \vec{i} - (6t - 0) \vec{j} + (2-0) \vec{k}\\[10pt]
 &=6t^2 \vec{i} -6t \vec{j} + 2 \vec{k}\\[10pt]
 &=\vector{6t^2, - 6t, 2}
 \end{align*}
Finally, according to the third form of curvature, we have
\begin{align*}
\kappa &=  \frac{|\vec r\,'(t) \cross \vec r\,''(t)|}{|\vec r\,'(t)|^3}\\[10pt]
       &=  \frac{|\vector{6t^2,  -6t, 2}|}{|\vector{1, 2t, 3t^2}|^3}\\[10pt]
       &= \frac{\sqrt{36t^4 + 36t^2 + 4}}{(1 + 4t^2 + 9t^4)^{3/2}}\\[10pt]
...
\choice{$\displaystyle \frac{\sqrt 5}{(4t^2 + 5)^{3/2}}$}
\choice{$\displaystyle \frac{\sqrt {10}}{(4t^2 + 5)^{3/2}}$}
\choice[correct]{$\displaystyle \frac{2\sqrt 5}{(4t^2 + 5)^{3/2}}$}
\end{multipleChoice}
