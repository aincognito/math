...
%= a(ei-fh) - b(di-fg) + c(dh-eg)
%[with the vectors $\vec{i}, \vec{j}$ and $\vec{k}$ in the first row.
%= (y_1z_2 - z_1y_2)\vec{i} - (x_1z_2 - z_1x_2)\vec{j} + (x_1y_2-y_1x_2)\vec{k}which agrees with the definition above after multiplying through by $-1$ in the middle term.
