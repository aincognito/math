...
\filldraw[fill=blue!30!white, draw=blue] (0, 0) -- (5, 0) -- (8, 2) -- (3, 2) --(0,0);
\draw[red!70!white, fill] (4, 1) circle (0.05) node[right]{$Q$};
\draw[thick, red!70!white, ->] (4,1) -- (4, 4) node[right]{$\vec{n}$};
\draw (3.7, 1) -- (3.7, 1.3) -- (4, 1.3);
\node[blue] at (8, 1.5){$P$};
\node at (4, -1.8) {The vector $\vec{n}$ is normal to the plane $P$ at the point $Q$};
\end{tikzpicture}
\end{image}
