...
\vec{k} &= \vector{0, 0, 1}\\
\end{align*}
These are unit vectors in the directions of the positive $x, y$ and $z$-axes respectively.
...
\[
\arrowvec{PQ} = \vector{x_2 - x_1, y_2-y_1, z_2-z_1} %redefine \avec
\]
The magnitude of this vector is the distance between the points $P$ and $Q$
\[
|\arrowvec{PQ}| = \sqrt{(x_2-x_1)^2 + (y_2-y_1)^2 +(z_2-z_1)^2} = d(P, Q) %had a command defined \avec...what was it??
\]
