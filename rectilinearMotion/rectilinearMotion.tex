...
\[s(t) = t^3 - 3t^2 + 2,\]
where $s$ is measured in feet and $t$ is measured in seconds.
Compute the instantaneous velocity of the particle at time $t$, the initial velocity, the times when the partical 
...
The inital height is $\answer{12}$ feet.\\
The inital velocity is $\answer{48}$ feet/second.
