...
To find all the times that the particle is at rest, we need to solve the equation
\[v(t) = 0\]
for $t$.  
We have
\[3t^2 - 6t = 0\]
...
For the time interval, $[1,3]$ the situation is a little more complicated since the particle changes direction.
...
\begin{foldable}
\unfoldable{Here is a video of problem 5b}
\youtube{9Q2KMXCeXww} %vid of example 1
\end{foldable}
...
\begin{foldable}
\unfoldable{Here is a video of problem 7}
\youtube{PKokkti6Vas} %vid of example 1
\end{foldable}
