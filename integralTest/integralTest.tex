...
Then the improper integral and the associated infinite series
\[
\int_1^\infty f(x) \, dx\;\; \mbox{and} \;\;\sum_{n=1}^\infty a_n
\]
...
&= \frac12\lim_{t \to \infty} \left(\ln^2(t) - \ln^2(2) \right)\\
&= \infty.
\end{align*}
