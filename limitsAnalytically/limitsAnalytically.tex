...
\title{1.4 Evaluating Limits Algebraically}
...
In each of the following laws, all the limits are assumed to exist.
...
\item[7.]
 ...
 \[
 \lim_{x \to c} \frac{f(x)}{g(x)} = \dfrac{\lim_{x \to c} f(x)}{\lim_{x \to c} g(x)}, 
 \]
...
Here is a video solution to problem 5b:
\begin{foldable}
\youtube{nbR9Qn_yZ-w}
\end{foldable}
...
Here is a video solution to problem 9b:
\begin{foldable}
\youtube{WrtfOvKp0aw}
\end{foldable}
