...
\begin{align*}
\lim_{x \to 4} \frac{x^2 - 16}{x^2 - 4x} &= \lim_{x \to 4} \frac{(x+4)(x-4)}{x(x-4)} \enspace & \text{(factoring)} \\[.3 em]
                                         &= \lim_{x \to 4} \frac{x+4}{x} & \text{(canceling)} \\[.3 em]
                                         &= \frac84  &  \\[.3 em]
																				 &= 2. &
\end{align*}																				
...
\enspace & \text{(factoring)} \\[.3 em]
&= \lim_{x \to 2} \frac{x+5}{x^2 + 2x + 4} & \text{(canceling)} \\[.3 em]
&= \frac{2+5}{2^2 + (2\cdot 2) + 4} & \text{(plugging in)} \\[.3 em]
&= \frac{7}{12}. 
\end{align*}
...
\enspace & \text{(factoring)} \\[.3 em]
&= \lim_{x \to 4} \frac{4x-3}{6x + 5} & \text{(canceling)} \\[.3 em]
&= \frac{16-3}{24+5} & \text{(plugging in)}\\[.3 em]
&= \frac{13}{29}. 
\end{align*}
...
\begin{align*}
\lim_{x \to 4} \frac{\sqrt{x}- 2}{x-4} &=
\lim_{x \to 4} \frac{\sqrt{x} -2}{x-4}\cdot \frac{\sqrt{x} +2}{\sqrt{x}+2} \\[.3 em]
 &= \lim_{x \to 4} \frac{x-4}{(x-4)(\sqrt{x}+2)} \\[.3 em]
&= \lim_{x \to 4}\frac{1}{\sqrt{x}+2} \\[.3 em]
&= \frac 14.
\end{align*}
...
\begin{align*}
\lim_{x \to 1} \frac{x- \sqrt{x}}{x-1} &=
\lim_{x \to 1} \frac{x- \sqrt{x}}{x-1}\cdot \frac{x+ \sqrt{x}}{x+ \sqrt{x}} \\[.3 em]
 &= \lim_{x \to 1} \frac{x^2- x}{(x-1)(x+ \sqrt{x})} \\[.3 em]
&= \lim_{x \to 1} \frac{x(x-1)}{(x-1)(x+ \sqrt{x})} \\[.3 em]
&= \lim_{x \to 1}\frac{x}{x+ \sqrt{x}} \\[.3 em]
&= \frac 12.
\end{align*}
...
\lim_{x \to -3} \left(\frac{x^2 - 9}{4 - \sqrt{13 -x}}\right) \cdot \left(\frac{4 + \sqrt{13 -x}}{4 + \sqrt{13 -x}}\right) \\[.3 em]
&=\lim_{x \to -3} \frac{(x^2 - 9)(4 + \sqrt{13 -x})}{x+3}\\[.3 em]
&=\lim_{x \to -3} \frac{(x+3)(x-3)(4 + \sqrt{13 -x})}{x+3} \\[.3 em]
&= \lim_{x \to -3} (x-3)(4 + \sqrt{13 -x})\\[.3 em]
&= (-3-3)(4 + \sqrt{13- (-3)}) \\[.3 em]
&= (-6)(4 + 4) \\[.3 em]
&= -48.
\end{align*}
\end{example}
...
\begin{align*}
\lim_{x \to 4} \frac{\frac{1}{x} - \frac{1}{4}}{x-4} &= \lim_{x \to 4} \frac{\frac{4-x}{4x}}{x-4}\\[.3 em]
&=\lim_{x \to 4} \frac{4-x}{4x(x-4)}\\[.3 em]
&= \lim_{x \to 4} -\frac{1}{4x} \\[.3 em]
&= -\frac{1}{16}.
\end{align*}
...
\begin{align*}
\frac{2}{x-3} + \frac{x+4}{5} &= \frac{10 + (x-3)(x+4)}{5(x-3)}\\[.3 em]
&= \frac{x^2 +x -2}{5(x-3)} \\[.3 em]
&= \frac{(x-1)(x+2)}{5(x-3)}.
\end{align*}
Now back to the original problem:
\begin{align*}
\lim_{x \to -2} \frac{\frac{2}{x-3} + \frac{x+4}{5}}{x^2 + 5x + 6} &= 
\lim_{x \to -2} \frac{\frac{(x-1)(x+2)}{5(x-3)}}{(x+2)(x+3)}\\[.3 em]
&= \lim_{x \to -2} \frac{(x-1)(x+2)}{5(x-3)(x+2)(x+3)} \\[.3 em]
&= \lim_{x \to -2} \frac{(x-1)}{5(x-3)(x+3)}\\[.3 em]
...
\begin{align*}
\lim_{x \to 3^-} \frac{|x-3|}{x-3} &= \lim_{x \to 3^-} \frac{-(x-3)}{x-3} \\[.3 em]
&= \lim_{x \to 3^-} (-1) \\
&= -1.
\end{align*}
\end{example}
