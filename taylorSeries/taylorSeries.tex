...
\begin{array}{|c|c|c|c|} 
\hline
\raisebox{7pt}{\phantom{i}}\textbf{$n$} & \textbf{$f^{(n)}(x)$} & \textbf{$f^{(n)}(a), a = 4$} & \textbf{$c_n$} \\[1em] 
\hline
\raisebox{7pt}{\phantom{i}} 0 & x^{1/2} & 4^{1/2} = 2 & 2 \\[1em]
\hline
\raisebox{12pt}{\phantom{i}} 1 & \frac12 x^{-1/2} & \frac12 \cdot 4^{-1/2} = \frac14 & \frac14 \\[1em]
\hline
\raisebox{12pt}{\phantom{i}}  2 & -\frac14 x^{-3/2} & -\frac14 \cdot 4^{-3/2} 
