...
\choice{$u_x = u_r \cos \theta - v_r \sin \theta$ \;\; and \;\; $u_y = u_r \sin \theta + v_r \cos \theta $}
\choice{$u_x = u_r \sin \theta + v_r \cos \theta$ \;\; and \;\; $u_y = u_r \cos \theta - v_r \sin \theta $}
\choice[correct]{$u_x = u_r \cos \theta + v_r \sin \theta$ \;\; and \;\; $u_y = u_r \sin \theta - v_r \cos \theta $}
\end{multipleChoice}
\end{problem}
