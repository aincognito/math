...
\begin{theorem}
Suppose $f(z) = u(x,y) + iv(x,y)$ has partial derivatives $u_x, u_y, v_x$ and $v_y$ that are continuous at a point $(x_0,y_0)$.
If these partial derivatives satisfy the Cauchy-Riemann Equations at this point, then $f(z)$
...
we will add and subtract the term $u(x,y+k)$ in the numerator of the limit above.
This leads to 
\[
