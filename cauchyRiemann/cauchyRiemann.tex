...
\begin{hint}
$f$ is nowhere differentiable since $u_x \neq v_y$ at any point $(x_0, y_0)$
\end{hint}
ii) \;\; & f(z) = e^{\overline{z}} \\
...
\begin{hint}
$u_x = v_y$ implies $\cos y =0$
\end{hint}
\begin{hint}
$u_y = -v_x$ implies $\sin y =0$
\end{hint}
\begin{hint}
$f$ is nowhere differentiable since these equations are never satified simultaneously
\end{hint}
...
\begin{hint}
$f$ is differentiable at the points $(\frac{\pi}{2} +k\pi, 0)$
\end{hint}
\end{align*}
\end{problem}
