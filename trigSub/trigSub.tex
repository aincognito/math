...
\node[right, blue] at (3.5,1.6) {$\sqrt{1-x^2}$}; %opposite 
...
\node[right, blue] at (0.2,0.2) {$\theta$};
\node[below, blue] at (1.75,-0.1) {$x$}; %adjacent
\node[right, blue] at (3.5,1.6) {$\sqrt{4-x^2}$}; %opposite 
%\node[right] at (4.1,2) {$\tan(\theta)$};
...
\node[right, blue] at (3.5,1.6) {$\sqrt{9-4x^2}$}; %opposite 
%\node[right] at (4.1,2) {$\tan(\theta)$};
...
\node[right, blue] at (3.5,1.6) {$\sqrt{x^2 - 1}$}; %opposite 
%\node[right] at (4.1,2) {$\tan(\theta)$};
...
\node[right, blue] at (3.5,1.6) {$\sqrt{x^2 - 4}$}; %opposite 
%\node[right] at (4.1,2) {$\tan(\theta)$};
\node[above, blue] at (1.3,1.5) {$x$}; %hypotenuse
\node[below] at (1.75,-0.6) {The opposite side is calculated using the Pythagorean theorem};
...
\node[right, blue] at (0.2,0.2) {$\theta$};
\node[below, blue] at (1.75,-0.1) {$2$}; %adjacent
\node[right, blue] at (3.5,1.6) {$\sqrt{9x^2 - 4}$}; %opposite 
%\node[right] at (4.1,2) {$\tan(\theta)$};
...
\node[right, blue] at (3.5,1.6) {$\sqrt{x^2 - 25}$}; %opposite 
%\node[right] at (4.1,2) {$\tan(\theta)$};
\node[above, blue] at (1.3,1.5) {$x$}; %hypotenuse
\node[below] at (1.75,-0.6) {The opposite side is calculated using the Pythagorean theorem};
...
%\node[right] at (4.1,2) {$\tan(\theta)$};
\node[above, blue] at (1,1.5) {$\sqrt{1 + x^2}$}; %hypotenuse
...
\node[right, blue] at (3.5,1.6) {$x$}; %opposite 
%\node[right] at (4.1,2) {$\tan(\theta)$};
\node[above, blue] at (1,1.5) {$\sqrt{9 + x^2}$}; %hypotenuse
\node[below] at (1.75,-0.6) {The hypotenuse is calculated using the Pythagorean theorem};
...
%\node[right] at (4.1,2) {$\tan(\theta)$};
\node[above, blue] at (0.8,1.5) {$\sqrt{16 + 9x^2}$}; %hypotenuse
\node[below] at (1.75,-0.6) {The hypotenuse is calculated using the Pythagorean theorem};
...
because $\ln(u/v) = \ln(u) - \ln(v)$ and $-2\ln(4)$ can be combined with the constant of integration.
\end{example}
...
\begin{problem}
Use a trigonometric substitution to convert the integral into a trigonometric integral: $\dis \int x^3 \sqrt{x^1 -4} \; dx$\\
