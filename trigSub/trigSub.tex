...
\int x^3 \sqrt{1-x^2} \; dx &= \int \cos^3(\theta) \sqrt{1-\cos^2(\theta)} \left[-\sin(\theta)\right] \; d\theta\\[6pt]
                           ...
                           &= -\int \cos^3(\theta) \sin^2(\theta) \; d\theta\\[6pt]
                           \text{now, $u$-sub, with} \; & \; \text{  $u = \sin(\theta), \; du = \cos(\theta) \, d\theta$}\\[6pt]
                           &=-\int \cos^3(\theta) u^2 \; \frac{du}{\cos(\theta)}\\[6pt]
                           &=-\int \cos^2(\theta) u^2 \; du\\[6pt]
                           &=-\int \left[1-\sin^2(\theta)\right] u^2 \; du\\[6pt]
                           &=-\int (1-u^2)u^2 \; du\\[6pt]
                           &=\int (u^2 -1)u^2 \; du\\[6pt]
                           &=\int (u^4 - u^2) \; du\\[6pt]
                           \text{now we can} & \text{ finally integrate}\\[6pt]
