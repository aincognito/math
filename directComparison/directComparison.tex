...
We state this formally in the theorem below, in which the original series is denoted by $\sum_{n=0}^\infty a_n$ 
and the second series whose behavior is know is denoted by $\sum_{n=0}^\infty b_n$.


\begin{theorem}[Direct Comparison Test]
 Suppose $a_n \geq 0$ and $b_n \geq 0$ for all values of $n$.\\
(Convergence) If $a_n \leq b_n$ for all values of $n$, \textbf{and} if $\sum_{n=0}^\infty b_n$ converges, 
then the series $\sum_{n=0}^\infty a_n$ also converges.\\
(Divergence) If $b_n \leq a_n$ for all values of $n$, \textbf{and} if $\sum_{n=0}^\infty b_n$ diverges, 
then the series $\sum_{n=0}^\infty a_n$ also diverges.
\end{theorem}


\begin{remark}
If $a_n > b_n \geq 0$ for all $n$ and $\sum_{n=0}^\infty b_n$ converges, then the DCT gives \textbf{no conclusion} about $\sum_{n=0}^\infty a_n$.
Also, If $0 \leq a_n < b_n$ for all $n$ and $\sum_{n=0}^\infty b_n$ diverges, then the DCT gives \textbf{no conclusion} about $\sum_{n=0}^\infty a_n$.
\end{remark}


\begin{example}[Convergence] %example #1
Determine if the series $\sum_{n=1}^\infty \frac{1}{2n^2 + 3}$ converges or diverges.\\
We will use the DCT with the convergent p-series $\sum_{n=1}^\infty \frac{1}{n^2}$. 
To make the comparison, first note that $2n^2 + 3 > n^2 > 0$ for all $n \geq 1$. By taking the reciprocal of both sides,
we have 
\[
\frac{1}{2n^2 + 3} < \frac{1}{n^2} \; \; \text{ for } \; \; n \geq 1,
\]
and so by the DCT, $\sum_{n=1}^\infty \frac{1}{2n^2 + 3}$ also converges.
\end{example}


\begin{problem}[DCT 1]
Consider the series $\sum_{n=1}^\infty \frac{1}{n^3 + 1}$.
...
\begin{multipleChoice}
\choice[correct]{ $\frac{1}{n^3 + 1} \leq \frac{1}{n^3}$ for $n \geq 1$}
\choice{$\frac{1}{n^3 + 1} \geq \frac{1}{n^3}$ for $n \geq 1$}
\end{multipleChoice}

Describe the behavior of the series $\sum_{n=1}^\infty \frac{1}{n^3 + 1}:$
\begin{multipleChoice}
...
\begin{example}[Convergence] %example #2
...
\]
Therefore, by the DCT, $\sum_{n=0}^\infty \frac{3^n}{4^n + 1}$ also converges.
\end{example}
...
\begin{example}[Convergence] %example #3
...
\]
and so by the DCT, $\sum_{n=1}^\infty \frac{\sin^2(n)}{n^3}$ also converges.
\end{example}
...
\begin{example}[No Conclusion] %example #4
...
\]
and so by the DCT, $\sum_{n=2}^\infty \frac{1}{\sqrt{n^2 -1}}$ also diverges.
\end{example}
...
\begin{example}[Divergence] %example #6
...
\]
and so by the DCT, $\sum_{n=0}^\infty \frac{2^n + 5}{3^n}$ also diverges.
\end{example}
...
\begin{example}[Divergence] %example #7
...
\]
and so by the DCT, $\sum_{n=2}^\infty \frac{1}{\ln(n)}$ also diverges.
\end{example}


\begin{example}[No Conclusion] %example #8
