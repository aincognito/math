...
(Case 1: Convergence) If $a_n \leq b_n$ for all values of $n$, \textbf{and} if $\sum_{n=0}^\infty b_n$ converges, 
then the series $\sum_{n=0}^\infty a_n$ also converges.\\
(Case 2: Divergence) If $b_n \leq a_n$ for all values of $n$, \textbf{and} if $\sum_{n=0}^\infty b_n$ diverges, 
