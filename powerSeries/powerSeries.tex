...
the power series representation is $f(x) = $
\begin{multipleChoice}
\choice{$\displaystyle{ \sum_{n=0}^\infty (-1)^n \frac{x^n}{8^n}, \; |x|< 2}$}
\choice[correct]{$\displaystyle{\sum_{n=0}^\infty (-1)^2\frac{x^n}{8^{n+1}}, \;  |x|< 2}$}
\choice{$\displaystyle{\sum_{n=0}^\infty \frac{x^n}{8^{n+1}}, \;  |x|< 2}$}
\end{multipleChoice}
\end{problem}
