...
\begin{tikzpicture}
\begin{scope}
\draw[clip, draw = none] (0,0) arc (0:180:2) --cycle;
\draw[outer color = blue!50, inner color = white, shading = radial] (-2,0) circle (2);
%\draw[ color = blue!50,shading = radial] (-2,0) circle (2);
\end{scope}
 
 \begin{scope}
\draw[clip, draw = none] (0,0) arc (0:-180:2) --cycle;
\draw[outer color = red!50, inner color = white] (-2,0) circle (2);
\end{scope}
